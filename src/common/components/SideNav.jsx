...
const SideNav = () => {
    return (
        <div className='divide-y divide-[#F0F0F0] w-52 fixed top-0'>
            <div>
                <div className='mx-4 my-2 flex gap-2'>
                    <div><FiMenu size={36} className='p-2 hover:bg-[#E5E5E5] hover:rounded-full' /></div>
                    <div className='flex'>
            ...
            <div className='divide-y divide-[#F0F0F0] overflow-y-scroll h-screen pb-16'>
